...
// END DYNAMIC ITME TO ADD TO ORDER WINDOW ===========================================================================
    ...
    //     return (
    //     <CustomButton1>{category.category_name}</CustomButton1>
    //     );
    // })
        ...
        <>
            ...
            {categoryitems.length ? (
                categoryitems.map(row => {
                    ...
                    return (
                <Col>
                    <Button className="Appetizers-row-button" variant="secondary" onClick={() => { handleClick(items) }} >{row.itemName}</Button>
                </Col>
                );
                    })
                ) : (
